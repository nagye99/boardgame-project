...
/**
 * This class represents the {@link boardgame.model.Direction} where the blue pieces can move.
 */
public enum BlueDirection implements Direction {
    ...
    /**
     * Creates a {@code BlueDirection} object.
     *
     ...
     * @return the appropiate direction of the {@code BlueDirection}
     */
